            ...
            <div className="flex h-16 items-center">
              ...
              <div className=" flex lg:ml-0">
                <a href="#" className="text-[20px]">
                  <span className="text-red-700 font-extrabold">E</span>c
                ...
                <>
                  <div className="ml-auto flex items-center">
                    ...
                    <div className="ml-4 flow-root lg:ml-6">
                      ...
                      >
                        <LuShoppingCart className="text-[20px] outline-0 b" />
                        <span className="ml-2 text-sm font-medium text-gray-700 group-hover:text-gray-800 absolute right-0 top-[5px] text-green-900">
                          0
                        </span>
